...
<figure>
	<center>
  <img src="{{ '/assets/img/2016-8-3-Dunn/refmsNIRS.jpg' | prepend: site.baseurl }}" style="display: inline-block; max-width:80%; height:auto; margin-right:30px; auto;" alt=""></center>
</figure>
