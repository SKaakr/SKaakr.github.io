...
2. As <em>brain activates</em>, <span style="color:red">oxyhemoglobin</span> goes up and <span style="color:blue">deoxyhemoglobin</span> goes down. As a result, you can use fNIRS to detect areas of brain activity by measuring the changes in amounts of these compounds.
